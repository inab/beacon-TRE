...
routes = [
    ...
    web.get('/api/analyses/filtering_terms', filtering_terms_handler(db_fn=analyses.get_filtering_terms_of_analyses)),
    web.get('/api/analyses/{id}', generic_handler(db_fn=analyses.get_analyses_with_id)),
    web.get('/api/analyses/{id}/g_variants', generic_handler(db_fn=analyses.get_variants_of_analyses)),
    ...
    web.post('/api/analyses/filtering_terms', filtering_terms_handler(db_fn=analyses.get_filtering_terms_of_analyses)),
    web.post('/api/analyses/{id}', generic_handler(db_fn=analyses.get_analyses_with_id)),
    web.post('/api/analyses/{id}/g_variants', generic_handler(db_fn=analyses.get_variants_of_analyses)),
